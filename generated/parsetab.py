...
_lr_signature = '38EF9B1EF6200F19A52D686413BDDE7C'
...
_lr_productions = [
  ...
  ('op_expression -> primary_expression','op_expression',1,'p_expression_op_02','parser_C2PC.py',89),
  ('expression -> equality_expression','expression',1,'p_expression_assign','parser_C2PC.py',93),
  ('relational_expression -> op_expression','relational_expression',1,'p_relational_expression_01','parser_C2PC.py',97),
  ('relational_expression -> assignation','relational_expression',1,'p_relational_expression_01','parser_C2PC.py',98),
  ('relational_expression -> relational_expression LESS op_expression','relational_expression',3,'p_relational_expression_02','parser_C2PC.py',102),
  ('relational_expression -> relational_expression GREATER op_expression','relational_expression',3,'p_relational_expression_02','parser_C2PC.py',103),
  ('relational_expression -> relational_expression LESS_EQ op_expression','relational_expression',3,'p_relational_expression_02','parser_C2PC.py',104),
  ('relational_expression -> relational_expression GREATER_EQ op_expression','relational_expression',3,'p_relational_expression_02','parser_C2PC.py',105),
  ('equality_expression -> relational_expression','equality_expression',1,'p_equality_expression_01','parser_C2PC.py',109),
  ('equality_expression -> equality_expression EQ relational_expression','equality_expression',3,'p_equality_expression_02','parser_C2PC.py',113),
  ('equality_expression -> equality_expression NOT_EQ relational_expression','equality_expression',3,'p_equality_expression_02','parser_C2PC.py',114),
]
